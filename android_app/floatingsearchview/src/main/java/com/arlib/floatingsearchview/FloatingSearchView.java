...
public class FloatingSearchView extends FrameLayout {
    ...
    private final static int BACKGROUND_DRAWABLE_ALPHA_SEARCH_FOCUSED = 30;
    ...
    private String mSearchHintBefore;
    private String mSearchHintAfter;
    ...
    private OnOverflowMenuInflated mOnOverflowMenuInflated;
    ...
    public interface OnOverflowMenuInflated{
        void onOverflowMenuInflated();
    }
    /**
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mSearchHintBefore= a.getString(R.styleable.FloatingSearchView_floatingSearch_searchHintBeforeFocus);
            mSearchHintAfter= a.getString(R.styleable.FloatingSearchView_floatingSearch_searchHintAfterFocus);
            mSearchInput.setHint(mSearchHintBefore);
    ...
    private void setupQueryBar() {
        ...
        mSearchInput.setOnFocusChangeListener(getDefaultOnFocusListener());
        ...
        mLeftAction.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isSearchBarFocused() && mOnHomeActionClickListener != null){
    ...
    public TextView.OnFocusChangeListener getDefaultOnFocusListener(){
        return new TextView.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if(hasFocus){
                    mSearchInput.setHint(mSearchHintAfter);
                }else{
                    mSearchInput.setHint(mSearchHintBefore);
                }
            }
    ...
    public void inflateOverflowMenu(int menuId) {
        ...
        if(mOnOverflowMenuInflated!=null){
            mOnOverflowMenuInflated.onOverflowMenuInflated();
        }
    }
    ...
    public void setOnOverflowMenuInflated(OnOverflowMenuInflated listener){
        this.mOnOverflowMenuInflated = listener;
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.searchHintBefore = mSearchHintBefore;
        savedState.searchHintAfter = mSearchHintAfter;
    ...
    static class SavedState extends BaseSavedState {
        ...
        private String searchHintBefore;
        private String searchHintAfter;
        ...
        private SavedState(Parcel in) {
            ...
            searchHintBefore = in.readString();
            searchHintAfter = in.readString();
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeString(searchHintBefore);
            out.writeString(searchHintAfter);
